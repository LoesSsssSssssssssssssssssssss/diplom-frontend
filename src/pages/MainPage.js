...
function MainPage() {
  ...
  const accordionData = [
    {
      question: 'Есть ли учебник, если я уже не новичок?',
      answer:
        'Да, на нашей платформе вы можете узнать для себя что-то новое, даже, если вы опытный разработчик.',
    },
    {
      question: 'Я забыл на какой теме остановился?',
      answer:
        'На сайте есть система отслеживания прогресса, благодаря которой вы всегда знаете, на какой теме остановились.',
    },
    {
      question: 'Актуальна ли информация?',
      answer: 'Да, учебники постоянно обновляются.',
    },
    {
      question: 'Мне очень понравился учебник, как я могу его оценить?',
      answer:
        'После прохождения учебника в Вашем личном кабинете у вас появится возможность его оценить.',
    },
  ];
